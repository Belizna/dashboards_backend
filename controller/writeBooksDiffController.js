...
export const edit_write_diff_books = async (req, res) => {
    try {
...
export const add_write_diff_books = async (req, res) => {
    try {
...
export const delete_write_diff_books = async (req, res) => {
    try {
